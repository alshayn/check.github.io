!function (e) { if ("object" == typeof exports && "undefined" != typeof module) module.exports = e(); else if ("function" == typeof define && define.amd) define([], e); else { var a; "undefined" != typeof window ? a = window : "undefined" != typeof global ? a = global : "undefined" != typeof self && (a = self), a.hsimp = e() } }(function () {
    return function e(a, r, o) { function n(s, t) { if (!r[s]) { if (!a[s]) { var l = "function" == typeof require && require; if (!t && l) return l(s, !0); if (i) return i(s, !0); var c = new Error("Cannot find module '" + s + "'"); throw c.code = "MODULE_NOT_FOUND", c } var d = r[s] = { exports: {} }; a[s][0].call(d.exports, function (e) { var r = a[s][1][e]; return n(r || e) }, d, d.exports, e, a, r, o) } return r[s].exports } for (var i = "function" == typeof require && require, s = 0; s < o.length; s++)n(o[s]); return n }({
        1: [function (e, a, r) { a.exports = { "ASCII Lowercase": ["[a-z]", 26], "ASCII Uppercase": ["[A-Z]", 26], "ASCII Numbers": ["\\d", 10], "ASCII Top Row Symbols": ["[-!@£#$%^&*()=+_]", 15], "ASCII Other Symbols": ["[\\s\\?\\/\\.>,<`~\\|;:\\]}\\[{'\"\\\\]", 19], "Unicode Latin 1 Supplement": ["[\\u00A1-\\u00A2\\u00A4-\\u00FF]", 93], "Unicode Latin Extended A": ["[\\u0100-\\u017F]", 128], "Unicode Latin Extended B": ["[\\u0180-\\u024F]", 208], "Unicode Latin Extended C": ["[\\u2C60-\\u2C7F]", 32], "Unicode Latin Extended D": ["[\\uA720-\\uA7FF]", 29], "Unicode Cyrillic Uppercase": ["[\\u0410-\\u042F]", 32], "Unicode Cyrillic Lowercase": ["[\\u0430-\\u044F]", 32] } }, {}], 2: [function (e, a, r) { "use strict"; var o = e("hsimp-library"), n = {}, i = o.prop(0), s = o.prop(1), t = function (e) { var a = {}, r = 0, t = []; if (!o.isString(e)) throw Error("CharacterSet: Invalid type"); return o.forEach(function (a, o) { e.match(i(a)) && (t.push(o), r += s(a)) }, n), a.getSets = function () { return t }, a.getPossibleCharacters = function () { return r }, a }; t.setCharacterSets = function (e) { n = e }, a.exports = t }, { "hsimp-library": 10 }], 3: [function (e, a, r) { a.exports = { common: { name: "Распространенный пароль: Входит в топ {{ value }} самых используемых паролей", message: "Ваш пароль очень часто используется. Он будет взломан мнгновенно" }, lengthVeryShort: { name: "Длина: Слишком Короткий Пароль", message: "Ваш пароль слишком короткий. Чем длиннее пароль, тем надежнее он будет." }, possiblyWord: { name: "Возможно Слово", message: "Ваш пароль выглядит так, как будто это слово или имя. Если это имя имеет личное значение для вас, то злоумышленникам будет легко догадаться. Если это слово, то его можно очень быстро взломать." }, onlyNumbers: { name: "Разнообразие знаков: Просто Цифры", message: "Ваш пароль состоит только из цифр. Это резко сокращает количество возможных комбинаций." }, wordAndNumber: { name: "Возможно слово и число", message: "Ваш пароль выглядит так, будто это просто слово и несколько цифр. Это очень распространенная схема, и ее очень быстро взломают." }, lengthShort: { name: "Длина: Слишком Короткий Пароль", message: "Ваш пароль довольно короткий. Чем длиннее пароль, тем надежнее он будет." }, justLetters: { name: "Разнообразие знаков: Просто Буквы", message: "Ваш пароль состоит только из букв. Добавление цифр и символов может сделать ваш пароль более безопасным." }, noSymbols: { name: "Разнообразие знаков: Нет символов", message: "Ваш пароль состоит только из цифр и букв. Добавление символов может сделать ваш пароль более безопасным." }, telephone: { name: "Возможно Телефонный Номер / Дата", message: "Ваш пароль выглядит так, как будто это номер телефона или дата. Если это так, и это имеет личное значение, то кому-то может быть очень легко догадаться." }, repeatedPattern: { name: "Повторяющаяся Структура", message: "Повторяющиеся символы или структуры могут сделать ваш пароль более предсказуемым." }, nonStandardCharacters: { name: "Разнообразие знаков: Нестандартные знаки", message: "Ваш пароль содержит неклавиатурный символ. Это должно сделать его более безопасным." }, lengthLong: { name: "Длина: Слишком Длинный Пароль", message: "Ваш пароль более 16 знаков" } } }, {}], 4: [function (e, a, r) { "use strict"; var o, n = e("hsimp-library"), i = [], s = function (e) { return n.filter(function (e) { return e }, n.map(function (a) { return a(e) }, n.reduce(function (e, a) { return e.concat(a.get()) }, [], i))) }, t = function (e) { if (o.hasOwnProperty(e.id)) { var a = o[e.id]; return { level: e.level, name: e.value ? a.name.replace("{{ value }}", e.value) : a.name, message: e.value ? a.message.replace("{{ value }}", e.value) : a.message } } throw new Error("checker: Missing dictionary entry " + e.id) }, l = function (e) { if (!o) throw new Error("checker: dictionary not set"); var a, r = {}, i = ["highlight", "insecure", "warning", "achievement", "notice"]; if (!n.isString(e)) throw Error("checker: Invalid type"); return a = n.map(t, s(e)).sort(function (e, a) { var r = function (e) { var a = i.indexOf(e.level); return -1 === a ? i.length : a }; return r(e) - r(a) }), r.isInsecure = function () { return n.some(function (e) { return "insecure" === e.level }, a) }, r.hasWarnings = function () { return n.some(function (e) { return "warning" === e.level }, a) }, r.hasAchievements = function () { return n.some(function (e) { return "achievement" === e.level }, a) }, r.getChecks = function () { return a }, r }; l.setDictionary = function (e) { o = e }, l.setChecks = function (e) { var a = new Error("setChecks takes an array of check objects"); if (!n.isArray(e)) throw a; e.forEach(function (e) { if (!n.isFunction(e.get)) throw a }), i = e }, a.exports = l }, { "hsimp-library": 10 }], 5: [function (e, a, r) { "use strict"; var o = e("hsimp-library"), n = function (e) { if (!o.isFunction(e)) throw new Error("Check is not a function"); var a = {}, r = []; return a.setDictionary = function (e) { r = e }, a.get = function () { return e(r) }, a }; a.exports = n }, { "hsimp-library": 10 }], 6: [function (e, a, r) { "use strict"; var o = e("hsimp-library"), n = e("../check"); a.exports = n(function (e) { return [function (a) { var r; return a = a.toLowerCase(), o.forEach(function (e, o) { if (e === a) return r = 5 * Math.ceil((o + 1) / 5), !1 }, e), !!r && { level: "insecure", id: "common", value: r } }] }) }, { "../check": 5, "hsimp-library": 10 }], 7: [function (e, a, r) { "use strict"; var o = e("hsimp-library"), n = e("../check"); a.exports = n(function (e) { return o.map(function (e, a) { var r = new RegExp(a); return function (a) { return !!r.test(a) && e } }, e) }) }, { "../check": 5, "hsimp-library": 10 }], 8: [function (e, a, r) { a.exports = { "^correcthorsebatterystaple$": { level: "insecure", id: "xkcd" }, "^jeff|geoff$": { level: "easteregg", id: "jeff" }, "^.{1,6}$": { level: "warning", id: "lengthVeryShort" }, "^[a-zA-Z]{1,16}$": { level: "warning", id: "possiblyWord" }, "^[0-9]+$": { level: "warning", id: "onlyNumbers" }, "^([a-zA-Z]+[0-9]+|[0-9]+[a-zA-Z]+)$": { level: "warning", id: "wordAndNumber" }, "^.{7,9}$": { level: "warning", id: "lengthShort" }, "^[A-Za-z]+$": { level: "notice", id: "justLetters" }, "^(?:\\d+[a-zA-Z]|[a-zA-Z]+\\d)[a-zA-Z\\d]*$": { level: "notice", id: "noSymbols" }, "^[\\-\\(\\)\\.\\/\\s0-9]+$": { level: "warning", id: "telephone" }, "(.+)\\1{2,}": { level: "warning", id: "repeatedPattern" }, "[^A-Za-z0-9\\u0000-\\u007E]": { level: "achievement", id: "nonStandardCharacters" }, "^.{17,}$": { level: "achievement", id: "lengthLong" } } }, {}], 9: [function (e, a, r) {
